    ...
    <PageTransition>
        <Navbar/>
            <div>
                ...
                {myOrders.length === 0 ?
                    <div className='text-center max-w-7xl mx-auto px-6 py-20 md:min-h-136 flex flex-col items-center'>
                        <h1 className='text-3xl md:text-4xl mb-3 flex items-center gap-2 text-red-600'><PackageX size={34} color='red'/>Oops! No Orders Found</h1>
                    ...
                    <div className='px-6 py-4'>
                        <div className='flex flex-col gap-2'>
                            <h1 className='font-medium text-2xl md:text-3xl'>My Orders</h1>
                                ...
                                <div className='flex flex-col gap-8 w-full'>
                                    <div className='flex flex-col gap-3'>
                                        <div className='flex gap-2'>
                                            <h1 className='text-lg md:text-xl font-medium'>Order ID:</h1>
                                            <h2 className='text-lg md:text-xl font-medium'>#{order.id}</h2>
                                        </div>
                                        <h1 className='text-gray-500'>{order.orderDate}</h1>
                                    </div>
                                    <h2 className='font-medium md:font-bold flex items-center justify-center text-green-700 bg-green-50 w-24 md:w-26 rounded-2xl h-7 md:h-8 border border-green-300'>Processing</h2>
                                </div>
